...
pimcore.plugin.processmanager.executor.logger.file = Class.create(pimcore.plugin.processmanager.executor.logger.abstractLogger, {
        ...
        this.form = new Ext.form.FormPanel({
            ...
            items: [
                ...
                this.getCheckbox('simpleLogFormat'),
                {
                    ...
                    name: "class",
                    readOnly: true,
                    value: '\\Elements\\Bundle\\ProcessManagerBundle\\Executor\\Logger\\File'
                }
            ],
    ...
    showLogs: function (monitoringItemId, loggerIndexPositions) {
        ...
        this.stopRefresh();
        var url = '/admin/elementsprocessmanager/monitoring-item/log-file-logger?id=' + monitoringItemId + '&loggerIndex=' + loggerIndexPositions;
