...
pimcore.plugin.processmanager.panel.monitoringItem = Class.create({
    ...
    createGrid: function(response) {
        ...
        var url = "/plugin/ProcessManager/monitoring-item/list?";
        ...
        gridColumns.push({header: t("plugin_pm_command"), width: 800, sortable: true, dataIndex: 'command',hidden : true, filter: 'string'});
        ...
        gridColumns.push({header: t("plugin_pm_executedByUser"), width: 100, sortable: false, dataIndex: 'executedByUser', filter: 'string'});
            ...
            gridColumns.push({
                ...
                items: [{
                    ...
                    handler: function (grid, rowIndex) {
                        ...
                        Ext.Ajax.request({
                            url: '/plugin/ProcessManager/monitoring-item/delete',
        ...
        var buttons = [
            {
                ...
                handler: function(){
                    ...
                    Ext.Ajax.request({
                        url: '/plugin/ProcessManager/monitoring-item/delete-batch',
                        params: values,
                        method : 'post',
                        success: function (response) {
                            var data = Ext.decode(response.responseText);
