pimcore.registerNS("pimcore.plugin.processmanager.executor.pimcoreCommand");
pimcore.plugin.processmanager.executor.pimcoreCommand = Class.create(pimcore.plugin.processmanager.executor.abstractExecutor,{
