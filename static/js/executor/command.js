pimcore.registerNS("pimcore.plugin.processmanager.executor.command");
pimcore.plugin.processmanager.executor.command = Class.create(pimcore.plugin.processmanager.executor.abstractExecutor,{
