...
pimcore.plugin.processmanager.executor.action.abstractAction = Class.create({
    ...
    removeForm: function (id) {
        Ext.getCmp('plugin_process_manager_action_panel').remove(Ext.getCmp(id));
    },
    ...
    addForm : function(){
        Ext.getCmp('plugin_process_manager_action_panel').add(this.getForm());
        this.form.updateLayout();
        Ext.getCmp('plugin_process_manager_action_panel').updateLayout();
        return this.form;
    }
});