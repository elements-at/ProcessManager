...
pimcore.plugin.processmanager.executor.logger.application = Class.create(pimcore.plugin.processmanager.executor.logger.abstractLogger,{
        ...
        this.form =  new Ext.form.FormPanel({
            ...
            items: [
                this.getLogLevelField(),
                {
                    ...
                    name: "class",
                    readOnly: true,
                    value: '\\ProcessManager\\Executor\\Logger\\Application'
                }
            ],
    ...
    showLogs : function (monitoringItemId,loggerIndexPositions) {
        this.stopRefresh();
        var url = '/plugin/ProcessManager/monitoring-item/log-application-logger?id=' + monitoringItemId + '&loggerIndex='+loggerIndexPositions;
        Ext.Ajax.request({
            url: url,
