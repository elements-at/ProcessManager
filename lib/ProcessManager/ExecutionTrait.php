...
trait ExecutionTrait {
  ...
  /*  protected function getLogger()
    {
        $logger = parent::getLogger(); // TODO: Change the autogenerated stub
        if(is_null($this->loggerInitialized) && $this->getMonitoringItem()){
            $logger->pushHandler(new StreamHandler($this->getMonitoringItem()->getLogFile(), Logger::DEBUG));
            \Zend_Registry::set('process_manager_logger',$logger);
